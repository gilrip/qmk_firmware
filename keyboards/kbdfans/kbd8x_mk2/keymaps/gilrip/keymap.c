...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( /* Base */
	...
	KC_LGUI, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_DEL,           KC_INS,  KC_HOME, KC_PGUP, \
	...
	KC_LALT, KC_NO,   KC_LGUI,                            KC_SPFN,                                      KC_LGUI, KC_LALT, KC_LALT, KC_LALT,          KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
  [1] = LAYOUT( /* Base */
	...
	_______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, \
	_______, _______, KC_UP,   _______, KC_MHME, KC_MEND, _______, _______, _______, _______, _______, _______, _______,          _______,          _______, _______, _______, \
