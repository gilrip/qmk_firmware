...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL,        KC_LALT, KC_LGUI,                            KC_SPFN,                             KC_RALT, MO(2),   KC_LGUI,   KC_RCTL
    ),
    [1] = LAYOUT_60_ansi(
        KC_GESC, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
        _______, _______, KC_UP,   _______, KC_MHME, KC_MEND, KC_CALC, _______, KC_INS,  _______, _______, _______, _______, _______,
